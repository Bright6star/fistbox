    ...
    <div class="box">
    	<!-- 表单 -->
	  	<form id="productForm" action="product" method="post">
	  		<input type="hidden" name="_method" value="addproduct"/>
	    	<table width="98%" class="tab">
	    		...
	    		<tr align="left">
	        	 	<td>信息标题：<input type="text" name="product_name" size="30" id="product_name"/></td>
			    </tr>
			    <tr>
			    	<td>额定电压：
			    	<input type="text" name="product_voltage" id="product_voltage"/>
			    	额定功率：
			    	<input type="text" name="product_power" id="product_power"/>
			    	</td>
			    </tr>
			    <tr>
			    	<td>放水等级：
			    	<input type="text" name="product_water" id="product_water"/>
			    	额定压力：
			    	<input type="text" name="product_pressure" id="product_pressure"/>
			    	</td>
			    </tr>
			    <tr>
			    	<td>外&nbsp;&nbsp;壳：
			    	<input type="text" name="product_shell" id="product_shell"/>
			    	容&nbsp;&nbsp;量：
				...
				<tr><td>信息内容：<br/>
					<textarea name="content" cols="100" rows="13" id="content"></textarea>
				</td></tr>
